...
const ContextStates = ({ children }) => {
  ...
  const sendOTP = async (mobile, username) => {
    try {
      setLoading(true)
      const response = await fetch('http://13.61.35.6/api/auth/sendOTP', {
        method: 'Post',
        headers: {
  ...
  const fetchLogin = async (mobile, otp) => {
    try {
      setLoading(true)
      const response = await fetch('http://13.61.35.6/api/auth/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const fetchSignup = async (name, mobile, otp) => {
    try {
      setLoading(true)
      const response = await fetch('http://13.61.35.6/api/auth/signup', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const fetchUser = async () => {
    ...
    const response = await fetch(
      `http://13.61.35.6/api/auth/getUser`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        const res = await fetch(
          "http://13.61.35.6/api/auth/getCarsInUserCity",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const fetchRegisterCar = async (CarDetails) => {
    try {
      ...
      const response = await fetch(
        "http://13.61.35.6/api/car/registerCar",
        {
          method: "POST",
          body: formData,
          credentials: "include",
  ...
  const fetchCarList = async (filters) => {
    setLoading(true)
    const response = await fetch("http://13.61.35.6/api/car/carList", {
      method: "POST",
  ...
  const saveCar = async (car_id) => {
    ...
    const response = await fetch('http://13.61.35.6/api/car/saveCar', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json'
      },
  ...
  const unsaveCar = async (car_id) => {
    const user_id = user._id
    console.log(user_id, car_id)
    const response = await fetch('http://13.61.35.6/api/car/unsaveCar', {
      method: 'POST',
      headers: {
        'Content-type': 'application/json'
      },
  ...
  const addRecentlyViewedCars = async (car_id) => {
    const response = await fetch(`http://13.61.35.6/api/car/recentlyViewedCars`, {
      method: 'Post',
      headers: {
        'Content-type': 'application/json'
      },
  ...
  const fetchLogout = async () => {
    try {
      setLoading(true)
      const response = await fetch('http://13.61.35.6/api/auth/logout', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
